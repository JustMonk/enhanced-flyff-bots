...
class SectionCard(Container):
    def __init__(self, children=None, *args, header='', **kwargs):
        ...
        self.set_style({'padding': '20px', 'margin-bottom': '10px', 'display': 'block', 'overflow': 'hidden', 'box-shadow': '0px 3px 1px -2px rgba(0,0,0,0.2),0px 2px 2px 0px rgba(0,0,0,0.14),0px 1px 5px 0px rgba(0,0,0,0.12)', 'width': 'auto', 'border-radius': '10px'})
        ...
        self.header.type = 'h1'
        self.header.add_class('card-header')
